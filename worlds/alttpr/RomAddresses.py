# Values are taken from ALttPDoorRandomizer. Not gonna import them atm because
# it would require adding a lot of dependencies used by their MultiClient.py.

INGAME_MODES = {0x07, 0x09, 0x0b}  # Underworld, overworld, and special overworld (dark world??), respectively
ENDGAME_MODES = {b'\x19', b'\x1a'}  # No clue why {0x19, 0x1a} wasn't working ¯\_(ツ)_/¯
DEATH_MODES = {0x12}
